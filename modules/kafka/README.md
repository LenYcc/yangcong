# kafka-go [![CircleCI](https://circleci.com/gh/segmentio/kafka-go.svg?style=shield)](https://circleci.com/gh/segmentio/kafka-go) [![Go Report Card](https://goreportcard.com/badge/yangcong/modules/kafka)](https://goreportcard.com/report/yangcong/modules/kafka) [![GoDoc](https://godoc.org/yangcong/modules/kafka?status.svg)](https://godoc.org/yangcong/modules/kafka)
...
`kafka-go` is currently compatible with golang version from 1.15+. To use with older versions of golang use release [v0.2.5](https://yangcong/modules/kafka/releases/tag/v0.2.5).

## Connection [![GoDoc](https://godoc.org/yangcong/modules/kafka?status.svg)](https://godoc.org/yangcong/modules/kafka#Conn)
...
## Reader [![GoDoc](https://godoc.org/yangcong/modules/kafka?status.svg)](https://godoc.org/yangcong/modules/kafka#Reader)
...
## Writer [![GoDoc](https://godoc.org/yangcong/modules/kafka?status.svg)](https://godoc.org/yangcong/modules/kafka#Writer)
...
#### [Plain](https://godoc.org/yangcong/modules/kafka/sasl/plain#Mechanism)
```go
...
#### [SCRAM](https://godoc.org/yangcong/modules/kafka/sasl/scram#Mechanism)
```go
