...
are you testing against, and your operating system.
 ...
 - [kafka-go Issues segmentio/kafka-go](https://yangcong/modules/kafka/issues)
...
mkdir $HOME/src
cd $HOME/src
git clone https://yangcong/modules/kafka.git
cd kafka-go
go build ./...
```
...
1. Add the following entry to the beginning of the modules file.
    ...
    replace yangcong/modules/kafka v1.2.3 => ../local/directory
